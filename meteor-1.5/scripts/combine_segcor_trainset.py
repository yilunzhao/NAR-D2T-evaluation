...
def main(argv):
    ...
    for hterDir in hterDirs:
        ...
        shutil.copy(
            os.path.join(hterDir, "tst.sgm"), os.path.join(outDir, base + ".tst")
        )
        shutil.copy(
            os.path.join(hterDir, "ref.sgm"), os.path.join(outDir, base + ".ref")
        )
        shutil.copy(
            os.path.join(hterDir, "ter.seg"), os.path.join(outDir, base + ".ter")
        )
